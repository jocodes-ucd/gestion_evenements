...
// 1. Récupérer TOUS les événements (Pas de limite)
        ...
        <div class="row g-3 align-items-center">
            <div class="col-md-6">
                <div class="fw-bold text-muted">
                    ...
                    Affichage de <?= count($all_events) ?> événement(s)
                </div>
            </div>
            <div class="col-md-6 text-md-end">
                <a href="index.php" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
                    <i class="bi bi-arrow-left"></i> Retour Accueil
                </a>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card card-custom h-100 group-hover">
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            <small class="text-uppercase fw-bold text-primary mb-2">
                            ...
                            <p class="text-secondary small flex-grow-1">
                                <?= substr(htmlspecialchars($event['description']), 0, 80) ?>...
                            </p>

                            <a href="event_details.php?id=<?= $event['id'] ?>" class="btn btn-outline-dark fw-bold rounded-3 mt-3 w-100">
                                Voir & Réserver
                            </a>
                        </div>
                    </div>
        ...
        <?php else: ?>
            <div class="col-12 text-center py-5">
                <div class="alert alert-light shadow-sm d-inline-block px-5">
                    ...
                    <p>Vérifiez que vous avez bien créé des événements dans l'admin.</p>
                </div>
            </div>
        <?php endif; ?>
    </div>
